...
const InvoiceCreate = ({ projectId, isLoading, create }) => {
    ...
    return (
        <>
            ...
            <SendInvoiceEmailForm projectId={projectId} show={show} create={create} isLoading={isLoading} setShow={setShow} setPayload={setPayload} contactPersons={[]}/>
        </>
    )
}
