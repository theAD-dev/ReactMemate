      ...
      const events = [
        ...
        },
        {
          ...
          <li>
            ...
            <strong>Company Trip to Bangkok</strong>
          </li>
          <li><span>BS</span></li>
          </ul>`,
          bubbleHtml:
            "<div style='font-weight:bold'>Hold design workshops</div><div>Hold engaging design workshops that foster creativity and collaboration. These hands-on sessions help teams brainstorm, prototype, and refine ideas, ensuring innovative solutions and a user-focused approach to product development.</div>",
        },
      ];
