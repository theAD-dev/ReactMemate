...
const CompanyName = () => {
  ...
  const handleStepOne = () => {
    ...
    if (!is_agree_marketing) {
      setCheckError('Please agree to receive marketing communications from MeMate.');
      return;
    }
 
    navigate("/selectdate", { state: { first_name,last_name,country,phone,email,company_name ,company_description,company_size,is_agree_marketing} });
              ...
              <div className="boxinfo">
                <div className="boxLogin">
                  ...
                  <div className="formgroup">
                    ...
                    {options.map((option) => (
                      <div key={option.value} className={`option inputInfoSizeCheck ${company_size === option.value ? 'active' : ''}`}>
                        <input
                          type="radio"
                          className='radioBtn'
                          id={option.value}
                  ...
                  <div className="formgroup">
                    <div className={``}>
                      <label id='inputInfocheckbox' className="inputInfocheckbox">Yes, I would like to receive marketing communications from MeMate
                          <input 
                          type="checkbox"
                        ...
                        />
                        <span className={`checkmarkdata ${checkError ? 'agree_marketing-border' : ''}`}></span>
                      </label>
                    </div>
