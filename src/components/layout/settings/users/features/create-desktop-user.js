...
const CreateDesktopUser = ({ visible, setVisible, id = null, setId, refetch }) => {
    ...
    console.log('readDesktopUserQuery: ', readDesktopUserQuery?.data);
    ...
    const roleOptions = [
        ...
        { label: 'Location Manager', value: '3' },
