                ...
                <div className="settings-content setModalelBoots">
                    <div className='headSticky'>
                        ...
                        <div className='contentMenuTab'>
                            <ul>
                                <li><Link to="/settings/termsandconditions/terms-and-conditions">Terms and Conditions Application</Link></li>
                                <li className='menuActive'><Link to="/settings/termsandconditions/terms-and-conditions-invoice">Terms and Conditions Invoice</Link></li>
                            </ul>
                        </div>
                    </div>
